...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Dashboard inteligente para gestão comercial, energética e sustentável de eletropostos." },
      { name: "author", content: "FIAP × GoodWe" },
      { property: "og:title", content: "ChargeGrid Intelligence" },
      { property: "og:description", content: "Gestão comercial e energética de eletropostos em tempo real." },
